...
ClientCreator.prototype.generateClientFileSource = function generateClientFileSource(serviceMetadata, specifiedVersion) {
  ...
  code += 'var OWLHUB = require(\'../lib/core\');\n';
  code += 'var Service = OWLHUB.Service;\n';
  code += 'var apiLoader = OWLHUB.apiLoader;\n\n';
  code += 'apiLoader.services[\'' + serviceName +'\'] = {};\n';
  code += 'OWLHUB.' + className + ' = Service.defineService(\'' + serviceName + '\', [\'' + [].concat(obsoleteVersions, versionNumbers).sort().join('\', \'') + '\']);\n';
  ...
  code += '\n';
  code += 'module.exports = OWLHUB.' + className + ';\n';
  return {
    code: code,
